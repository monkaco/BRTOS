               ...
               uint32_t ui32MsgValue, void *pvMsgData)
{
    ...
    switch(ui32Event)
    {
        ...
        case USBD_CDC_EVENT_SET_LINE_CODING:
        	...
        	{
        		flag = 1;
        		USBBufferWrite((tUSBBuffer *)&g_sTxBuffer, (unsigned char *)">> BRTOS Started!\n\r>", 20);
        	}else
        	{
        		flag = 0;
        	}
...
void USBUARTPrimeTransmit(void)
{
	...
	#if 0
    unsigned char txChar1[32] = "Teste de envio de caracter 1\n\r";
    unsigned char txChar2[32] = "Teste de envio de caracter 2\n\r";
	#endif
    //
...
void printf_usb(char *s)
{
	INT32U count = 0;
	INT32U written = 0;
	INT32U char_to_written = 0;
	INT32U written_char = 0;
	CHAR8  *string = s;
